...
EMI_IMG = "https://telegra.ph/file/0999e47689b8b250b8cd7.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @inigar \
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Gar Robot*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Gar Robot's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for GarRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/garbot16/EmikoRobot"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, GarRobot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="*๏ Gar Robot support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Gar Robot.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/garsupport"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/katagarr"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
